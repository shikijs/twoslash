        ...
        <article className="container border-red" id="twoslash">
          ...
          <div className="split-50-50">
            <div className="left-margin-1 ">
              ...
              <p>All code samples use Shiki, then you can opt-in to have Twoslash markup inside specific code blocks, provided they are TypeScript / JavaScript code blocks.</p>
              <p>
